...
{
  [[BluetoothResponder sharedInstance] setDelegate:self];
...
+ (BluetoothResponder *)sharedInstance {
  ...
  dispatch_once(&onceToken, ^{
    g_serviceUUID = [CBUUID UUIDWithString:@"D1D750AD-5C5A-4770-B4D6-8F48DC8A772A"];
    g_characteristicUUID = [CBUUID UUIDWithString:@"8423E61B-5209-47D8-9730-C35A17390839"];
